 ...
 */
package com.ruoyi.common.tool.query.advisor;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.ruoyi.common.tool.annotation.query.*;
import com.ruoyi.common.tool.query.constant.QueryConstant;
import com.ruoyi.common.tool.query.exception.QueryException;
import com.ruoyi.common.tool.query.parser.CriteriaFieldParser;
import com.ruoyi.common.tool.query.processor.*;
import com.ruoyi.common.tool.query.query.AbstractQuery;
import com.ruoyi.common.tool.query.util.ScanUtils;
...
public class CriteriaAnnotationProcessorAdvisor {
     ...
     * @return 指定的条件注解处理器
     */
    protected static CriteriaAnnotationProcessor findProcessor(final Class<? extends Annotation> processorClazz) {
        final CriteriaAnnotationProcessor processor = ANNOTATION_PROCESSOR_CACHE.get(processorClazz);
        if (null == processor) {
            throw new QueryException(String.format("No processor found:%s", processorClazz));
        }
